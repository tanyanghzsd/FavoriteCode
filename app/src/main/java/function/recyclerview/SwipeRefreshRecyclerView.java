...
public class SwipeRefreshRecyclerView extends SwipeRefreshLayout implements RecyclerViewAdapterDataObserver.OnAdapterDataChangedListener {
    ...
    public void setEmptyView(View emptyView) {
        ...
        // 监听数据变化
        mAdapterDataObserver = new RecyclerViewAdapterDataObserver(this);
