...
/**
 * Created by tanyang on 2018/3/28.
 */
...
public class DrawHookView extends View {
    ...
    private final String FIRST_COLOR = "#fa6403";
    ...
    protected void onDraw(Canvas canvas) {
        ...
        //设置画笔颜色
        paint.setColor(Color.parseColor(FIRST_COLOR));
        //设置圆弧的宽度
        ...
        int center1 = center - getMeasuredWidth() / 5;
        //圆弧半径
        int radius = getMeasuredWidth() / 2 - 5;
